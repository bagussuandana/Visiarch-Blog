...
? 'inline-flex items-center px-1 pt-1 border-b-2 border-sky-400 text-sm font-medium leading-5 text-gray-900
focus:outline-none focus:border-sky-700 transition duration-150 ease-in-out'
